...
function soundOff({ onSoundClick }) {
  return (
    <svg
      width="60px"
      height="60px"
      ...
      className="relative self-start left-4 top-4 border-4  border-pink-500 shadow-pink-400 shadow-inner rounded-full p-2 
                hover:cursor-pointer hover:bg-pink-900 active:ring-2 ring-white"
